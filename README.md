[![Build Status](https://dev.azure.com/adsbrain/temp/_apis/build/status/NickNickGo.ContosoAir?branchName=master)](https://dev.azure.com/adsbrain/temp/_build/latest?definitionId=1&branchName=master)
